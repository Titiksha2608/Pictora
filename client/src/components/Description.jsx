...
function Description() {
  return (
    ...
    >
      ...
      <motion.p 
        className='text-xl text-gray-900 mb-16 text-center'
        whileHover={{ 
          color: '#9333ea',
          scale: 1.02
        }}
      ...
      <div className='flex flex-col gap-8 md:gap-14 md:flex-row items-start max-w-6xl mx-auto rounded-2xl shadow-lg bg-white backdrop-blur-md p-6 transition-colors duration-500'>
        <motion.div
