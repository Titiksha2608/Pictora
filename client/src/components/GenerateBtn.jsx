    ...
    <motion.div initial= {{opacity:0.2, y:100}} transition={{duration:1}} whileInView={{opacity:1, y:0}} viewport={{once:true}} 
      ...
      >
        ...
        <motion.button 
          ...
          className='inline-flex items-center gap-2 px-12 py-3 rounded-full bg-black text-white m-auto cursor-pointer shadow-lg backdrop-blur-md border border-neutral-200 transition-colors duration-500'
